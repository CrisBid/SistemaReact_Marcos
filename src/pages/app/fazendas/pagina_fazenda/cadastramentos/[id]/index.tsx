    ...
    <Sidebar/>
      <Body>
        ...
        <div className= {"titulo"}>
          <h1>Gerenciamento da {farms?.name}</h1>
        </div>
        <div className={"pagina"}>
          ...
          <div className={"coluna_2"}>
            <BoxContainer>
              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/cadastramentos/safras/${id}`)} className= {"button"}>Safras</Button>
              </Grid>
              </div>
              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/cadastramentos/talhoes/${id}`)} className= {"button"}>Talhoes</Button>
              </Grid>
              </div>
              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/cadastramentos/colheita/${id}`)} className= {"button"}>Colheita</Button>
              </Grid>
              </div>
              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/cadastramentos/analises/${id}`)} className= {"button"}>Análises</Button>
              </Grid>
              </div>
            </BoxContainer>
