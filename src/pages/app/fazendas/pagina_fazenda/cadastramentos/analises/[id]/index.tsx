        ...
        <div className={"pagina"}>
          ...
          <div className={"coluna_2"}>
            <BoxContainer>
              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/planejamento/insumos/calagen/${id}`)} className= {"button"}>Análises de Solo</Button>
              </Grid>
              </div>
              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/planejamento/insumos/nutricao/${id}`)} className= {"button"}>Análises de Folha</Button>
              </Grid>
              </div>
            </BoxContainer>
