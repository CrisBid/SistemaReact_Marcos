    ...
    <Sidebar/>
      <Body>
        ...
        <div className= {"titulo"}>
          <h1>Gerenciamento Planejamento</h1>
        </div>
        <div className={"pagina"}>
          ...
          <div className={"coluna_2"}>
            <BoxContainer>
              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/planejamento/insumos/${id}`)} className= {"button"}>Insumos</Button>
              </Grid>
              </div>
              
              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/planejamento/atividades/${id}`)} className= {"button"}>Atividades</Button>
              </Grid>
              </div>

              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/planejamento/produtos/${id}`)} className= {"button"}>Produtos</Button>
              </Grid>
              </div>

              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/planejamento/produtos/${id}`)} className= {"button"}>Serviços</Button>
              </Grid>
              </div>
