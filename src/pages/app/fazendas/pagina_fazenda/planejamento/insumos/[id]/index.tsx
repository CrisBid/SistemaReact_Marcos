        ...
        <div className={"pagina"}>
          ...
          <div className={"coluna_2"}>
            <BoxContainer>
              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/planejamento/insumos/calagen/${id}`)} className= {"button"}>Calagem</Button>
              </Grid>
              </div>
              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/planejamento/insumos/nutricao/${id}`)} className= {"button"}>Nutrição</Button>
              </Grid>
              </div>
              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/planejamento/insumos/ph/${id}`)} className= {"button"}>PH</Button>
              </Grid>
              </div>
              <div>
              <Grid component={Paper} elevation={6} className= {"box"}>
                <Button onClick={() => router.push(`/app/fazendas/pagina_fazenda/planejamento/insumos/herbicida/${id}`)} className= {"button"}>Herbicida</Button>
              </Grid>
              </div>
            </BoxContainer>
